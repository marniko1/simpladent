	...
	<div class="in">
		<div class="section main_section" id="questionsSection_1">
			<div class="main_block">
				<h1>Pitanja?</h1>
				<div class="article">
					<p>Da li imate pitanje koje nije navedeno ovde? Kontaktirajte nas, biće nam zadovoljstvo da odgovorimo na Vaša pitanja direktno ili putem email-a.</p>					
				</div>
			<div class="clear"></div>
		</div>
...
<br/>
<li><strong>3.	Bezbolnost:</strong> <br/>
Nakon uklanjanja zuba, pacijenti mogu očekivati da se javi uobičajen bol izazvan samim uklanjanjem zuba. Međutim, ne treba očekivati nikakav dodatni bol zbog ugradnje implantata. Zbog toga, sam proces ugradnje implantata je bezbolan.</li>
</ul>
<br/>
<br/>
...
<h2>Moj doktor mi je objasnio da mi je neophodna augmentacija kosti pre ugradnje implantata.</h2>
...
<h2>Kako se pokazala Simpladent® metoda u poređenju sa drugim tretmanima imedijantnog opterećenja, fiksiranih zuba u roku od tri dana ili „All-on-4“?</h2>

„All-on-fo-4“ metoda podrazumeva ugradnju četiri konvencionalna implantata u vilicu pod uglom. (Slično „All-on-6“ predstavlja šest implantata usidrenih pod uglom). Ova metoda nosi brojne rizike: zbog malog broja implantata i popuštanja šrafova, frakture implantata se mogu očekivati tokom vremena. Samo jedan frakturiran implantat zahteve zamenu cele konstrukcije. To dovodi do povećanja troškova i produžava vreme potrebno za tretman. Pošto mastikatorni centar nije zamenjen, korektno žvakanje postaje teško. Dodatno, rizik od periimplantitisa ostaje visok, pogotovo za rizične grupe, kao što su pušači i dijabetičari. 
<br/>
Koncept Simpladent® tretmana zahteva ugradnju adekvatnog broja kortikalnih-bazalnih implantata u čvrste delove kosti za optimalnu stabilnost i dugotrajne rezultate. Oni su konstruisani za imedijantno opterećenje. 
<br/>
<br/>
...
<h2>Šta je periimplantitis i šta možemo preduzeti?</h2>
Što su duže u upotrebi konvencionalni 2-fazni implantati sa velikom, hrapavom površinom, veće su šanse za infekciju periodoncijuma i u okolini implantata. Infekcija je poznata kao periimplantitis i povezana je sa gubitkom kosti. Napredovanje infekcije i posledično smanjenje kvaliteta života pacijenta dovodi do uklanjanja implantata kasnije. Terapija konvencionalnim implantatima nije uspela.
<br/>
...
<br/>
<br/>
<h2>Koja je slaba strana Simpladent<sup>®</sup> metode?</h2>

Nema je, sa medicinskog aspekta postoje samo prednosti: brza je, bezbedna, pristupačna i predvidljiva. Nema skrivenih “trikova”. <br/>
<br/>
...
<br/>
<br/>
<h2>Objašnjenje estetskih rezultata u pojedinim slučajevima:</h2>
Povremeno nailazimo na tvrdnje da su estetski rezultati naše metode lošiji od rezultata konvencionalnim tretmanom. Ne slažemo se sa tvrdnjom da neproporcionalno pomažemo pacijentima koji nisu kandidati za konvencionalni tretman. Zbog toga je nemoguće porediti ova dva pristupa tretmanu.
<br/>
<ul style="margin-left:10px;">
	<br/>
	<li>U radu sa pacijentima koji imaju veliku količinu koštanog tkiva (vertikalno i horizontalno), dobri estetski rezultati mogu se postići svakom metodom. </li>
	<br/>
	<li>Ako pacijent ima veoma malu količinu koštanog tkiva (konvencionalni tretman je nemoguć, ne savetuje se ili održiv jedino uz prethodne ekstenzivne i rizične procedure augmentacija kosti), Simpladent metoda i u ovom slučaju može da ponudi uspešan tretman u protokolu imedijantnog opterećenja.</li>
	<br/>
	<li>U pojedinim slučajevima su neophodni kompromisi u estetskim rešenjima, zbog veoma redukovane količine kosti i promenjenog položaja oralne sluzokože. U ovim slučajevima specijalisti mogu da sugerišu dodatne terapijske korake, individualno primenljive.</li>
</ul>
</br>
</br>
</br>

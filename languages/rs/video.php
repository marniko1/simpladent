				...
				?>				
					<script>
						...
						for(a = 0; a<video_link.length;a++)
						{
							...
							jQuery('#video_link').append('<a href="#top"><div id="'+video_link[a]+'" style="background-image: url(http://img.youtube.com/vi/'+video_link[a]+'/mqdefault.jpg);" class="video_link_list"></div></a>');				
						}

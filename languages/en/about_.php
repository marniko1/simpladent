...
<div class="section main_section" id="aboutSection_1">
	<div class="author">
        ...
        <div class="article">
            <blockquote>I worked in Switzerland since 1994. I had more than 6,000 patients in my clinic, there was an enormous amount of work. I realized it was impossible to ever get it all done. Conventional methods of implantology were simply too time consuming and expensive; also patients simply often did not have enough bone.  
    ...
    <div class="main_block">
        ...
        <div class="article">
            ...
            <p>The Simpladent concept has changed the world of implantology entirely.</p>
            <p>In our clinics you will be freed of all dental worries and return to your normal life very quickly.</p>
            <ul>
                ...
                <li>Our expertly trained surgeons use cortical bone in all areas of the maxillo-facial skeletton. This bone is resorption-stable and strong. For this reason we are able to install bridges right away and splint the implants thereby.</li>

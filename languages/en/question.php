...
Many patient asks themselves this question – even more those who suffer a compromised state of health or chronic illness (such as diabetes), or who are heavy smokers.<br />
<br />
The answer is clearly: Yes! Over 99% of these patients are successfully treated with the Strategic Implant<sup>®</sup>.<br />
<br />
...
<br />
This is where the distinct advantages of Simpladent<sup>®</sup> implantology become apparent. The method is swift, reliable and predictable.<br />
<br />
...
<br />
The Strategic Implant<sup>®</sup> can be immediately loaded. The feared <a href="http://www.peri-implantitis.info/en/" target="_blank">peri-implantitis</a>, a dangerous infection, does not occur in this treatment method at all.
<br />
<br />
...
None, the medical aspects are solely advantageous: It is fast, safe, affordable and predictable. There are no hidden „tricks“. <br />
<br />
...
<br />
<br />
<h2>Note regarding aesthetic results in single cases:</h2>
...
<ul style="margin-left:10px;">
	<br />
	<li>Provided the patients possess a large amount of bone (vertical and horizontal bone supply), a good aesthetic result can be reached with any method.  </li>
	<br />
	<li>If the patient has only a very low supply of bone (so little that conventional treatment is impossible, not advisable, or only a viable option with extensive, risky bone augmentation procedures), the Simpladent method can still offer successful treatment in immediate loading.</li>
	<br />
	<li>In single cases we occasionally achieve asa result fixed teeth on stable imlants,  however an aesthetic compromise has to be accepted due to reduced bone supply.  In such cases it is often possible to improve the aesthetic result after the operation through additional steps in the field of aesthetic/plastic surgery.</li>
</ul>
</br>
</br>
</br>

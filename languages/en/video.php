            ...
            <div class="section main_section" id="videoSection_1">
				...
				?>				
					<script>
						...
						jQuery('#video_link2').append('<a href="#top"><div id="'+video_link_infofilm[0]+'" style="background-image: url(http://img.youtube.com/vi/'+video_link_infofilm[0]+'/0.jpg);" class="video_link_list"><div class="video_link_desc">'+video_desc_infofilm[0]+'</div></a>');

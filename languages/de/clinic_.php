...
<div id="page" class="about">
	...
	<div class="in">
		<div class="section main_section" id="clinicSection_1">
			<div class="author">
				<div class="img"><img src="/img/contact/clinics/<?php echo $clinic; ?>/logo.png" alt=""/></div>
				<div class="article">
		...
		<div class="section" id="clinicSection_2">
			...
			<div id="team_assis">
			<?PHP
				if($pic_assist->image != ''){ echo('<br /><b>'.$elements->slang->assistant.'</b><br />');}
			...
			<br />
			<br />
			<?PHP echo('<div class="Headline">'.$elements->slang->clinic.'</div><br />'); ?>
			<br />
			<?PHP
			...
			<br />
			<br />
			<?PHP echo('<div class="Headline">'.$elements->slang->accomodations.'</div><br />'); ?>
			<br />
			<?PHP
			//echo('<b>'.$elements->slang->clinic.'</b><br />');
				foreach($clElements->accomodation->acc as $pic_acc)
				{
					if($pic_acc->name != '')
					{

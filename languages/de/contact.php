            ...
            <div class="section" id="contactsSection_2">
                ...
                <div class="contactsMapBlock">
					...
					<div class="contactssection_2_left">
						...
						<br />-->
						<p><strong>SIMPLADENT® GmbH</strong></p>
						<p>Koordination für Anfragen auf Deutsch.</p>
						<br />
						<p><strong>Telefon:</strong> +41 55 293 39 12</p>
						<br />
						<p><strong>Mobil Tel.:</strong> +41 77 525 00 59 </p>
					</div>										
                    <div id="mapBlock">
                        <div id="map"></div>
					</div>
					...
					<div class="contactworldmap" style="">
						...
						<p style="width:464px; float:right;">Sehen Sie alle Kliniken auf der <a href="http://simpladent-implant.solutions/?page=map&i=5" target="_blank">Weltkarte</a></p>
					</div>				
					<br />	

...
Das Strategic Implant<sup>®</sup> darf sofort belastet werden. Die zu Recht gefürchtete <a href="http://www.peri-implantitis.info/de/" target="_blank">Periimplantitis </a>, eine gefährliche Infektion, tritt bei dieser Methode nicht auf. <br />
<br />
<br />
...
Ja, Sie sparen eine Menge Zeit und Geld.<br />
<br />
...
Umsteigen lohnt sich also fast immer. In einem chirurgischen Eingriff werden die konventionellen Implantate entfernt und sogleich Strategic Implants<sup>®</sup> platziert. Innerhalb von drei bis maximal fünf Tagen können Sie das Leben wieder lachend genießen.
<br />
<br />

<h2>Mein behandelnder Arzt sagt, ich brauche Knochenaufbau, da ich sonst keine Implantate bekommen kann.</h2>
...
<br />
Mit der Simpladent<sup>®</sup> Behandlungsmethode treten diese Probleme nicht. Nur ein einziger chirurgischer Eingriff ist notwendig, die Implantate sind einteilig und poliert, und die Versorgung erfolgt sofort. Fälle von Periimplatitis sind uns nicht bekannt.
<br />
<br />
...
Keine, sie hat unter medizinischen Aspekten nur Vorteile: sie ist schnell, sicher, erschwinglich und vorhersagbar. Es gibt keine versteckten „Tricks“. <br />
<br />
...
<br />
<br />
<h2>Hinweise zum im Einzelfall erzielbaren ästhetischen Ergebnis:</h2>
...
<ul style="margin-left:10px;">
	<br />
	<li>Sofern bei einem Patienten sehr viel Knochen (vertikales und horizontales Knochenangebot) vorliegt, dann kann mit jeder Methode ein gutes ästhetisches Ergebnis erzielt werden.</li>
	<br />
	<li>Sofern jedoch bei einem Patienten nur noch sehr wenig Knochen vorliegt (so dass mit herkömmlichen Implantat-Methoden keine Behandlung möglich ist, bzw. nur mit riskantem, umfangreichen zusätzlichen Knochenaufbau), kann mit der Simpladent-Methode immer noch erfolgreich in Sofortbelastung behandelt werden. Aufgrund der reduzierten Knochenverhältnisse und der veränderten Lage der Mundschleimhaut lässt sich jedoch gelegentlich nur ein ästhetisches Kompromissergebnis erreichen. In solchen Fällen werden Ihnen die Spezialisten eventuell zusätzliche Therapieschritte vorschlagen.</li>
	<br />
</ul>
</br>
</br>
